...
## Order of Syncing
   000. Creating locations and departments in quickbooks, to hard code them inside Tbl_campus table and on classref(code) before syncing invoices in sync single invoice method
