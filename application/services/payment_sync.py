...
class PaymentSyncService:
    ...
    def void_payment(self, payment_id: int, sync_token: str):
        """
        Void payment in QuickBooks by payment ID
        """
        self.logger.info(f"Voiding payment for payment ID: {payment_id}")
        if not payment_id:
