    ...
    try:
        ...
        with db_manager.get_mis_session() as db:
            ...
            qb_payload = sync_service.map_applicant_to_quickbooks_customer_update(
                ...
                sparse=True,
                SyncToken=fetch_result['data']['Customer']['SyncToken'] if fetch_result['success'] and fetch_result['data'].get('Customer') and fetch_result['data']['Customer'].get('SyncToken') else None
            )
